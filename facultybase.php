...
<!-- Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="addstudentfac.php" >
      ...
      <!-- Attendance Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="facultyleave.php" >
          <i class="fas fa-school"></i>
          <span>Applay Leave</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link" href="studentattendance.php">
          <i class="fas fa-info-circle" href="studentattendance.php"></i>
