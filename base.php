...
<!-- Page Wrapper -->
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Attendance Menu -->
      <li class="nav-item">
        <a class="nav-link collapsed" href="adminleavefac_view.php" >
          <i class="fas fa-school"></i>
          <span>Leave Management of faculty</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link collapsed" href="adminleavestu_view.php" >
          <i class="fas fa-school"></i>
          <span>Leave Management of student</span>
        </a>
      </li>

      <!-- Nav Item -ptrevious details-->
      <li class="nav-item">
        <a class="nav-link" href="viewfacultyprofile.php">
          <i class="fas fa-info-circle" href="viewfacultyprofile.php"></i>
          <span>faculty details</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="viewstudentprofile.php">
